...
otcdocs_repo_name = 'opentelekomcloud-community/fg-http-python-fastapi'
...
# Analytics app name
otcdocs_analytics_app = 'fg-http-python-fastapi'

# Those variables are needed for indexing into OpenSearch
otcdocs_doc_environment = 'public'
otcdocs_doc_link = '/'
otcdocs_doc_title = 'Example: FunctionGraph HTTP function using python and FastAPI'
otcdocs_doc_type = 'dev'
otcdocs_service_category = 'example'
otcdocs_service_title = 'fg-http-python-fastapi'
otcdocs_service_type = 'sdk'
otcdocs_search_environment = 'hc_de'
otcdocs_search_url = "https://opensearch.eco.tsi-dev.otc-service.com/"


otcdocs_projects = ["fg-http-python-fastapi"]
...
project = u'fg-http-python-fastapi'
...
rst_prolog = f"""
.. |github_repo| replace:: "https://github.com/opentelekomcloud-community/fg-http-python-fastapi.git"
"""
# version = "1.0.0"
# release = "1.0.0"
...
extlinks= {
    "github_repo_master": (f'https://github.com/opentelekomcloud-community/fg-http-python-fastapi/tree/{local_branch}/%s', "%s"),
